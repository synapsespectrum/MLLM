...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TTCA")

    # basic config
    parser.add_argument(
        "--experiment_name",
        type=str,
        default="fusion_cross_attention",
        help="experiment name, used for saving checkpoints and logs",
    )
    parser.add_argument(
        "--task_name",
        type=str,
    ...
    # data loader
    parser.add_argument(
        "--data", type=str, required=True, default="Agriculture", help="dataset type"
    )
    parser.add_argument(
        "--root_path",
        type=str,
    ...
    parser.add_argument(
        "--data_path", type=str, default="Agriculture.csv", help="data file"
    )
    parser.add_argument(
        "--features",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="num of heads in fused cross attention",
    )
    ...
    parser.add_argument(
        "--save_name", type=str, default="results.txt", help="save name"
    )
    parser.add_argument(
    ...
    print(
        "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!overwrite features to 'S' for univariate time series data and dim=1"
    )
    fix_seed = args.seed
    print(f"Now using seed {fix_seed}")
