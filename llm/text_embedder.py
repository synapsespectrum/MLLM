...
class TextEmbedder(nn.Module):
    ...
    def _llm(self, llm_model_name):
        ...
        elif llm_model_name == "RoBERTa":
            self.roberta_config = RobertaConfig.from_pretrained("FacebookAI/roberta-base")
            self.roberta_config.num_hidden_layers = self.llm_layers
    ...
    def forward(self, input_texts):
        ...
        text_embeddings = self.llm_model.get_input_embeddings()(
            input_ids
        )  # [num_text, max_input_model, d_model]
