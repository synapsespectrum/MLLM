    ...
    do
      ...
      do
        ...
        do
          ...
          echo "Running experiment: Dataset=$dataset, Model=$model_name, Input_len=$input_len, Pred_len=$pred_len"
          echo "Log saved to ./logs/${experiment_name}/${dataset}/terminal_il${input_len}_pl${pred_len}.log"
          ...
          python -u run.py \
            ...
            --root_path $root_path \
            --data_path $data_path \
            --model_id "${model_id}_${dataset}_il${input_len}_pl${pred_len}" \
            --model $model_name \
            --data $dataset \
            --features S \
            --seq_len $input_len \
            ...
            --train_epochs 50 \
            --patience 20 | ts '[%Y-%m-%d %H:%M:%S]' >> "./logs/${experiment_name}/${dataset}/terminal_il${input_len}_pl${pred_len}.log" 2>&1
