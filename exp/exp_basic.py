...
class Exp_Basic(object):
    ...
    def __setup_logging(self):
        ...
        setting = '{}_{}_{}_ft{}sl{}ll{}pl{}pw{}dm{}nh{}el{}dl{}df{}expand{}dc{}fc{}eb{}dt{}{}{}'.format(
            self.args.model,
            self.args.llm_model,
            self.args.data,
            self.args.features,
    ...
    def __setup_tracking(self):
        ...
        mlflow_base_path = os.path.join("./mlflow_track", self.args.data, self.args.experiment_name)
